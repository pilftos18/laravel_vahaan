...
// });
    ...
    // var defaultOrder = [];
    // @if(session('data.userRole') === 'admin')
    // defaultOrder = [[5, 'desc']]; // Default sorting for admins
    // @else
    // defaultOrder = [[7, 'desc']]
    // @endif
        ...
        $.ajax({
            ...
            success: function (response) {
                ...
                if (data.length === 0) {
                    ...
                    //     '</tr></thead>'+
                    //     '<tbody>'+
                    //     '<tr class="odd"><td valign="top" colspan="12" class="dataTables_empty text-center">No data available in table</td></tr>'+
                    //     '</tbody>';
                    ...
                    // // Construct table headers and empty table body
                    // var tableHeaders = '<thead><tr>' +
                    //     '<th>Sr.No</th>';
                    // @if(session('data.userRole') != 'admin')
                    //     tableHeaders += '<th>Organization</th>';
                    // @endif
                    ...
                    // // Append table headers and empty row
                    // $('#user_table').append(tableHeaders);
