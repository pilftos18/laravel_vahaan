                ...
                <aside id="sidebar" class="sidebar">
                  ...
                  <?php
                        ...
                        <li class="nav-item">
                            ...
                            <ul id="Report-nav" class="nav-content collapse " data-bs-parent="#sidebar-nav">
                                ...
                                <li>
                                    ...
                                    <i class="bi bi-circle"></i><span>Portal Activity</span>
                                    </a>
                                </li>
                                <li>
                    ...
                    @if(session('data.userRole') == 'admin')
						...
						@if(!in_array(session('data.Client_id'), [5, 15]))
                            <li class="nav-item">
                                <a class="nav-link collapsed" data-bs-target="#User-nav" data-bs-toggle="collapse" href="#">
                                    <i class="bi bi-award"></i><span>User</span><i class="bi bi-chevron-down ms-auto"></i>
                                </a>
                        ...
                        <li class="nav-item">
                            ...
                            <ul id="Report-nav" class="nav-content collapse " data-bs-parent="#sidebar-nav">
                                ...
                                <li>
                                    ...
                                    <i class="bi bi-circle"></i><span>API Activity</span>
                                    </a>
                                </li>
                                @endif
								...
								<li>
                                    <a href="{{asset('apireport')}}">
                                    <i class="bi bi-circle"></i><span>RC Activity</span>
                                    </a>
                                </li>
								<li>
                                    <a href="{{asset('apireport_dl')}}">
                                    <i class="bi bi-circle"></i><span>DL Activity</span>
                                    </a>
                                </li>
								@endif
                                <li>
                    ...
                    @if(session('data.userRole') == 'mis' || session('data.userRole') == 'Mis')
                    <li class="nav-item">
                        <a class="nav-link collapsed" data-bs-target="#BillReport-nav" data-bs-toggle="collapse" href="#">
