    ...
    $(document).ready(function() {
        ...
        $('#submitBtn').click(function() {
            ...
            if(isValidVehicleNumber === true && isValidVehicleNumber != '')
            {
                ...
                $.ajax({
                    url: "{{ route('pancard.pancardinvPostData') }}", // Path to controller through routes/web.php
                    type: 'POST',
                    data: { input: input},
                    dataType: 'json',
                    success: function(response) {
                        ...
                        console.log('response result AADHAR_NUM : '+response.result.AADHAR_NUM);
                        if(response.code == 200)
                        {
                            ...
                            $("#name").text(response.result.FIRST_NAME+' '+response.result.MIDDLE_NAME+' '+response.result.LAST_NAME);
                            $("#father").text(response.result.FATHER_NAME);
                            $("#dob_r").text(response.result.DOB);
                            $("#less_info").text(response.result.LESS_INFO);
                            $("#masked_aadhaar").text(response.result.AADHAR_NUM);
                            $("#phone_number").text(response.result.MOBILE_NO);
                            $("#gender").text(response.result.GENDER);
                            $("#full").text(response.result.FULL_ADDRESS);
                            $("#street_name").text(response.result.ADDRESS_2);
                            $("#country").text(response.result.COUNTRY);
                            $("#state").text(response.result.STATE);
                            $("#email").text(response.result.EMAIL);
                            $("#city").text(response.result.CITY);
                            $("#zip").text(response.result.PINCODE);
                            $("#aadhaar_linked").text(response.result.AADHAR_LINKED);
